...
/*! ics file function library written by Travis Krause and Kyle Hornberg */
    ...
    */
    makeCal: async (boardId) => {
        ...
        for(let x=0; x<board.cards.length; x++) {
            ...
            cal.addEvent(card.cardName, card.description, board.boardName, dueDate.date, dueDate.date)
        }

        let ret = cal.download(board.boardName);
        if(ret === false) {
