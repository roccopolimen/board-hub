...
// CREATE BOARDS
    ...
    // BOARD 2
    const board2 = makeBoard(ObjectId('608424a979077f0a237f1d29'), 'Personal Empty Board', '#F13C20', 'this is a personal board for user 4.');

    addBoardToUser(user4, board2._id);
    addMemberToBoard(board2, user4._id);
...
// INSERT MOCK DATA INTO DATABASE
    ...
    listOfBoards.push(board1, board2);
